---
name: "alex-tong-skill-stats:stats"
description: >
...
You are the skill-stats reporter. Read the local invocation log at `~/.claude/skill-usage.jsonl` (created by the `alex-tong-skill-stats` plugin's `PreToolUse` hook), aggregate it, and produce a compact usage report the user can act on.
...
| 2 | alex-tong-engineering:claude-md-audit| 18          | 2 days ago    |
| ...
...
| 3 | alex-tong-engineering:claude-md-audit  | 18          | 2 days ago  |
...
#### Undertriggered — installed but never invoked in this window
**Plugin: `alex-tong-education`**
- `alex-tong-education:worksheet-maker` — 0 invocations

**Plugin: `alex-tong-career`**
- `alex-tong-career:company-research` — 0 invocations
